...
# 系统提示模板
SYSTEM_PROMPTS = [
    "You are an AI assistant specialized in understanding 3D point cloud data with 6 dimensions: coordinates (x, y, z) and colors (r, g, b). ",
    "You are an AI assistant that can analyze 3D point cloud data, including spatial coordinates (x, y, z) and color information (r, g, b). ",
    "You are a helpful AI that can interpret 3D point clouds with position (x, y, z) and color (r, g, b) information. ",
    "You are an AI capable of processing and understanding 3D point cloud data containing xyz coordinates and rgb color values. "
]
...
def main():
    ...
    if args.output_jsonl is None:
        args.output_jsonl = os.path.join(args.output_dir, f"{args.dataset_name.lower()}.jsonl")
